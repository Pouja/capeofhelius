...
CCLabelBMFontAnimated* CCLabelBMFontAnimated::createWithTTF(const std::string& text, const std::string& fontFile, float fontSize, const Size& dimensions /* = Size::ZERO */, TextHAlignment hAlignment /* = TextHAlignment::LEFT */, TextVAlignment vAlignment /* = TextVAlignment::TOP */)
{
...
void CCLabelBMFontAnimated::animateInVortex(bool removeOnCompletion, bool createGhosts, float duration, int spins){
    ...
    for (int i = 0; i < numLetters(); i++) {
        ...
        float staggerAmount = cocos2d::RandomHelper::random_real(0.0f, 10.0f) /10.0f;
